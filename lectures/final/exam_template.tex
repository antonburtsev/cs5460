...
\part[5] Alice removes \texttt{xchg()} from the \texttt{acquire()} function. Explain what happens  when  she boots xv6 on a multi-processor machine, i.e., machine with more than one physical CPUs. 
