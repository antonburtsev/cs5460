...
\begin{figure}[h] 
\includegraphics[width=0.5\columnwidth]{figs/point-a-ans}
\label{fig:point-a}
\end{figure}
...
\begin{figure}[h] 
\includegraphics[width=0.8\columnwidth]{figs/point-b-ans}
\label{fig:point-b}
\end{figure}
...
\begin{figure}[h] 
\includegraphics[width=0.8\columnwidth]{figs/point-c-ans}
\label{fig:point-c}
\end{figure}
